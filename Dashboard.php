            ...
            <div class="dashboadHero">
               ...
               <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-form1" role="tabpanel"
                     ...
                     <h2 class="title my-4 text-center">Client Registration Form</h2>
                     <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                           ...
                           <?php
                              include 'config.php';
                              $c=1;
                              $result=mysqli_query($con,"SELECT * FROM `clientintakeform`");
                           ...
                           ?>
                              <tr>
                                 ...
                                 <td><a href="DashboardClientIntake.php?clientid=<?php echo $row['ClientID'];?>" class="prime-btn">View Detail</a></td>
                              </tr>
                              <?php
                                 };
                              ?>
