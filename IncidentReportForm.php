         ...
         <div class="">
            <div class="dashboadHero">
               ...
               <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade show active" id="pills-form2" role="tabpanel" aria-labelledby="pills-form2-tab" tabindex="0">
                     <h2 class="title my-4 text-center">Incident Documentation Form</h2>
                        ...
                        <table class="table table-bordered">
                           ...
                           <tbody>
                              <?php
                                 include 'config.php';
                                 $c=1;
                                 $result=mysqli_query($con,"SELECT * FROM `incidentreportformdetail`");
                              ...
                              <tr>
                                 ...
                                 <td><a href="DashboardIncidentReport.php?id=<?php echo $row['id'];?>" class="prime-btn">View Detail</a></td>
                              </tr>
                              <?php
                                    };
                              ?>
